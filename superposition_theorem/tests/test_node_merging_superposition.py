...
class TestNodeMergingSup(unittest.TestCase):
    ...
    def test_2_combined_actions_node_merging_by_hand(self):
        """Testing the combination of two nodes merging actions at different substations. Computing by hand the superposition of their unitary action state
        ...
        assert(delta_theta_sub2_obs1!=0)
        assert(delta_theta_sub2_obs_start!=0)
    ...
    def test_4_combined_actions_node_merging_sup_theorem(self):
        ...
        unitary_action_list = [{'set_bus': {'substations_id': [(5, (1, 1, 1, 1, 1, 1, 1))]}},  # sub5
                               {'set_bus': {'substations_id': [(4, (1, 1, 1, 1, 1))]}},  # sub4
                               {'set_bus': {'substations_id': [(3, (1, 1, 1, 1, 1, 1))]}},  # sub3
                               {'set_bus': {'substations_id': [(8, (1, 1, 1, 1, 1))]}},  # sub8
                               ]
